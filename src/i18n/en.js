export default {
	...
	download: {
		title: 'Download',
		description: 'Install the extension with one click from Chrome Web Store or build a custom version for your portal.',
		extension_btn: 'Download Extension',
		webstore_btn: "Install from Chrome Web Store",
		webstore_info: "Recommended",
		custom_section_title: 'Custom Portals',
		custom_section_description: 'If your Bitrix24 runs on a custom domain or local network, download the extension source and repackager app. Enter your portal address and get a ready-to-use extension.',
		...
		repackager_mac_info: 'macOS 11+ (Apple Silicon & Intel)',
